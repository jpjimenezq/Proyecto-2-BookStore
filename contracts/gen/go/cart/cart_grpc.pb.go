...
const (
	CartService_AddItem_FullMethodName    = "/bookstore.cart.CartService/AddItem"
	CartService_RemoveItem_FullMethodName = "/bookstore.cart.CartService/RemoveItem"
	CartService_GetCart_FullMethodName    = "/bookstore.cart.CartService/GetCart"
	CartService_ClearCart_FullMethodName  = "/bookstore.cart.CartService/ClearCart"
	CartService_Health_FullMethodName     = "/bookstore.cart.CartService/Health"
)
...
func (c *cartServiceClient) Health(ctx context.Context, in *common.Empty, opts ...grpc.CallOption) (*common.HealthStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.HealthStatus)
	err := c.cc.Invoke(ctx, CartService_Health_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCartServiceServer) Health(context.Context, *common.Empty) (*common.HealthStatus, error) {
...
func _CartService_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(common.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).Health(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_Health_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).Health(ctx, req.(*common.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bookstore.cart.CartService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Health",
			Handler:    _CartService_Health_Handler,
		},
	},
